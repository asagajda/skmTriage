...
import edu.isi.bmkeg.digitalLibrary.bin.AddPmidEncodedPdfs;
...
public class _04_PopulateTriageCodesFromPmidListTest {
	
	ApplicationContext ctx;
	
	String login, password, dbUrl;
	String triageCorpusName, targetCorpusName;
	File archiveFile, pmidFile_allChecked, triageCodes, pdfDir, codeFile;
